                ...
                <table class="table table-striped">
                    ...
                    @foreach(Auth::user()->posts as $post)
                        <tr>
                            ...
                            <td>
                                <a href="{{route('postEdit', $post->id)}}"><button class="btn-warning">Edit</button> </a>
                                <button type="button" class="btn-danger" data-toggle="modal" data-target="#deletePostModal-{{ $post->id }}">X</button>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
